...
create streaming table rajesh_silver.sales_cleaned_pl
(CONSTRAINT valid_order_id EXPECT (order_id IS NOT NULL) ON VIOLATION DROP ROW)
as
select distinct * from stream rajesh_bronze.sales_pl;
...
CREATE OR REFRESH STREAMING TABLE rajesh_silver.products_cleaned;

CREATE FLOW product_flow
AS AUTO CDC INTO
  rajesh_silver.products_cleaned
...
CREATE OR REFRESH STREAMING TABLE rajesh_silver.customers_cleaned;

CREATE FLOW customer_flow
AS AUTO CDC INTO
  rajesh_silver.customers_cleaned
